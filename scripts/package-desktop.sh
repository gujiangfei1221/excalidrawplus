...
NO_PROXY=0
HTTP_PROXY_VALUE="http://127.0.0.1:8001"
SOCKS_PROXY_VALUE="http://127.0.0.1:8001"
...
Usage:
  ...
  ./build-desktop.command --http-proxy http://127.0.0.1:8001 --socks-proxy http://127.0.0.1:8001
